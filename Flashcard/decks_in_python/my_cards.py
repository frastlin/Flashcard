...
test = deck("Test stuff")
c = test.add_card
c("Here is a voice", "Here is the back text", front_media="sounds/speech.ogg") 
c("Here is another card", "Hello doggies")

deck_list = [deck1, deck2, test]
