#First there is a dict with a list of dicts of each voice, second there is a language dict with the abriviation, then the english name, then there is the languages with the english name, then the abreviation.
